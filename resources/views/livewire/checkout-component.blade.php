            ...
            <form wire:submit.prevent="placeOrder" onsubmit="$('#processing').show();">
                    ...
                    <div class="col-md-12">
                        <div class="wrap-address-billing">
                            ...
                            <div class="billing-address">
                                ...
                                <p class="row-in-form">
                                    <label for="country">Line2:<span>*</span></label>
                ...
                <div class="summary summary-checkout">
                    <div class="summary-item payment-method">
                        ...
                        @if ($errors->isEmpty())
                            <div wire:ingore id="processing" style="font-size:22px; margin-botton:20px; padding-left:37px; color:green; display:none;">
