...
<html lang="en">
    <head>
        ...
        <link
            rel="stylesheet"
            type="text/css"
            href="{{ asset('assets/css/flexslider.css') }}"
        />
        <link
            rel="stylesheet"
            type="text/css"
            href="{{ asset('assets/css/chosen.min.css') }}"
        />
        <link
            rel="stylesheet"
            type="text/css"
        ...
        <link
            rel="stylesheet"
            type="text/css"
            href="{{ asset('assets/css/color-01.css') }}"
        />
        <link
    ...
    <body class="home-page home-01">
                ...
                <div class="row">
                    <div class="topbar-menu-area">
                        <div class="container">
                            ...
                            <div class="topbar-menu right-menu">
                                <ul>
                                    <li
                                        class="menu-item lang-menu menu-item-has-children parent"
                                    >
                                    ...
                                    <li
                                        class="menu-item menu-item-has-children parent"
                                    >
                    ...
                    <div class="container">
                        <div class="mid-section main-info-area">
                            ...
                            <div class="wrap-icon right-section">
                                ...
                                <div
                                    class="wrap-icon-section show-up-after-1024"
                                >
                    ...
                    <div class="nav-section header-sticky">
                        <div class="header-nav-section">
                            <div class="container">
                                <ul
                                    class="nav menu-nav clone-main-menu"
                                ...
                                >
                                    <li class="menu-item">
                                        <a href="#" class="link-term"
                                            >Weekly Featured</a
                                        ><span class="nav-label hot-label"
                                            >hot</span
                                        >
                                    </li>
                                    <li class="menu-item">
                        ...
                        <div class="primary-nav-section">
                            <div class="container">
                                <ul
                                    class="nav primary clone-main-menu"
                                    id="mercado_main"
                                ...
                                >
                                    ...
                                    <li class="menu-item">
                                        <a
                                            href="http://localhost:8080/laravel8ecommerce/public/shop"
                                            class="link-term mercado-item-title"
                                            >Shop</a
                                        >
                                    </li>
                                    <li class="menu-item">
                                        <a
                                            href="http://localhost:8080/laravel8ecommerce/public/cart"
                                            class="link-term mercado-item-title"
                                            >Cart</a
                                        >
                                    </li>
                                    <li class="menu-item">
                                        <a
                                            href="http://localhost:8080/laravel8ecommerce/public/checkout"
                                            class="link-term mercado-item-title"
                                            >Checkout</a
                                        >
                                    </li>
                                    <li class="menu-item">
                                        <a
                                            href="http://localhost:8080/laravel8ecommerce/public/contact-us"
                                            class="link-term mercado-item-title"
                                            >Contact Us</a
                                        >
                                    </li>
        ...
        <script src="{{
                asset('assets/js/jquery-ui-1.12.4.minb8ff.js?ver=1.12.4')
            }}"></script>
        ...
        <script
            src="https://cdn.tiny.cloud/1/bmjv1zqmnt80wcqrcnaykobq10jbsm4qy51hx1kymt1z8lag/tinymce/5/tinymce.min.js"
